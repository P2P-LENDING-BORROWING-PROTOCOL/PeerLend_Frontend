...
const Home = () => {
    ...
    const imageData = [
        ...
        {
            id: 2,
            imageLogo: 'https://media.licdn.com/dms/image/C560BAQFG7ISNb-AUTw/company-logo_200_200/0/1642534225011/meterio_logo?e=2147483647&v=beta&t=-h0e9FKCRGeV-2YhNvoDsveShdLk_piUHf9vi4xyYag'
        },
        {
            id: 3,
