...
const VerifyMail = () => {
    ...
    const sendOtpRequest = async (email) => {
        ...
        try {
            const res = await axios.post('https://email-service-backend-1.onrender.com/swagger-ui/index.html#/email-verification-controller/sendOtpMail', { email }, { headers });
    ...
    const verifyOtp = async () => {
        ...
        try {
            ...
            const res = await axios.post('https://email-service-backend-1.onrender.com/swagger-ui/index.html#/email-verification-controller/verifyOtpMail', { email, otp: otpCode }, { headers });
